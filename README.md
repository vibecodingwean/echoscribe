...
- **OpenAI, Gemini, xAI, ElevenLabs & Local AI Support:** Choose OpenAI, Google Gemini, xAI Grok, ElevenLabs Scribe v2, or a local Whisper-compatible endpoint for voice transcription.
...
- **ElevenLabs STT + TTS:** [Get API Key](https://elevenlabs.io/app/settings/api-keys) · [Voice Library](https://elevenlabs.io/app/voice-library)
